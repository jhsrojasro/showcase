...
function preload() {
  ...
  for (let i = 1; i <= 40; i++) {
    if (i.toString().length == 1) {
      photos.push(loadImage(`/showcase/content/sketches/shaders/paintings2/00000${i}.jpg`));
    } else {
      photos.push(loadImage(`/showcase/content/sketches/shaders/paintings2/0000${i}.jpg`));
    }
  }
}
